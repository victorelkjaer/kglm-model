...
@Predictor.register('fact-completion')
class FactCompletionPredictor(Predictor):
    def __init__(self,
                 model: Model,
                 sampler: Model,
                 dataset_reader_model: DatasetReader,
                 dataset_reader_sampler: DatasetReader) -> None:
        ...
        self._dataset_reader_model = dataset_reader_model
        self._dataset_reader_sampler = dataset_reader_sampler
    ...
    def _json_to_instance(self, json_dict: JsonDict) -> Instance:
        ...
        conditioning_instance = self._dataset_reader_sampler.text_to_instance(tokens[:-1])
        ...
        if 'shortlist' in json_dict:
            ...
            field = TextField(
                ...
                token_indexers=self._dataset_reader_sampler._entity_indexers)
        ...
        generative_instance = self._dataset_reader_model.text_to_instance([tokens[-1]])
        # Manually add the reset field here
